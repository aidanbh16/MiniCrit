...
export default function LoginForm(){
    ...
    return(
        <>
            <form action={formAction} className="w-1/2 h-4/5 m-auto flex flex-col justify-center gap-y-2" autoComplete="off">
                ...
                <input type="text" name="user" className="w-full h-1/8 p-1 mt-2 bg-white text-lg rounded-lg border-black border-1" placeholder="Username" defaultValue={state.username}></input>
