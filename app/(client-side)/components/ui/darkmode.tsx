...
export default function DarkModeToggle() {
  ...
  return (
    <button onClick={toggleTheme} type="button" className={`font-medium text-black rounded-full hover:cursor-pointer hover:text-[rgba(0,105,137,1)] dark:hover:text-white hover:bg-gray-200 dark:text-white dark:hover:bg-[rgba(51,28,101,1)]`}>
