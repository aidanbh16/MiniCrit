...
export default function DarkModeToggle() {
  ...
  return (
    <button onClick={toggleTheme} type="button" className={`font-medium text-black rounded-full hover:cursor-pointer hover:bg-gray-200 dark:text-neutral-200 dark:hover:bg-neutral-800`}>
